...
export const LandingPage = () => {
    return (
        <div className="flex flex-col min-h-screen bg-transparent">
            ...
            {/* Hero Section */}
            <section className="relative py-20 lg:py-32 overflow-hidden z-10 transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-in fade-in zoom-in duration-700">
                    <div>
                        <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-6">
                            Unlock Your Potential with <span className="text-primary-600 dark:text-primary-400">Mindporium</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <div className="transition-transform hover:scale-105 active:scale-95">
                                <Link to="/register">
                                    <Button size="lg" className="w-full sm:w-auto gap-2 bg-primary-600 hover:bg-primary-700 text-white border-0 shadow-lg shadow-primary-200 dark:shadow-primary-900/30">
                            ...
                            <div className="transition-transform hover:scale-105 active:scale-95">
                                <Link to="/courses">
                                    <Button variant="outline" size="lg" className="w-full sm:w-auto gap-2 bg-white/50 dark:bg-white/5 text-gray-900 dark:text-white border-gray-200 dark:border-white/20 hover:bg-white/80 dark:hover:bg-white/10 backdrop-blur-sm transition-all duration-300">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div
                                key={i}
                                className="p-8 rounded-2xl bg-white/60 dark:bg-white/5 backdrop-blur-lg border border-gray-200 dark:border-white/10 hover:shadow-lg dark:hover:bg-white/10 transition-all hover:-translate-y-1 duration-300 animate-in slide-in-from-bottom-4 fade-in fill-mode-backwards"
